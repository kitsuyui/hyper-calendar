...
| Solar Hijri as kept in Afghanistan | `persian-afghan` | Done, in `hc-calendars-equinox` — `persian`'s days under the Arabic names of the zodiac signs, حمل … حوت in Dari, with Pashto and English names in `hc-i18n`; civil from 1 Hamal 1336 (21 March 1957), when the month lengths were fixed (Balland, *Encyclopaedia Iranica*), to 7 Asad 1401 (29 July 2022), the eve of 1 Muharram 1444, from which official correspondence is dated by the lunar Hijri year, and in use after it beside the lunar dates. Iran's noon decides Nowruz; a noon at Kabul would move 1 Hamal in 1342, 1346, 1375 and 1379, which no authority read settles. `hc-holiday` has no Afghanistan table yet |
