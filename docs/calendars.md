...
| International Fixed (Cotsworth, 1902) | `international-fixed` | `hc-calendars-solar` | Planned — thirteen months of 28 days with *Sol* between June and July, *Year Day* and *Leap Day* both outside the week, the Gregorian leap rule; Kodak's calendar from 1928 to 1982. Cotsworth, *The Rational Almanac* (1905), is on archive.org |
...
| Positivist (Comte, 1849) | `positivist` | `hc-calendars-solar` | Planned — thirteen months of 28 days, the 365th day the *Fête générale des Morts* outside the week and a second such day in Gregorian leap years, year 1 in 1789; the *Catéchisme positiviste* (1852) is on Gallica |
...
| The Sun's nakṣatra (Kerala's ñāṭṭuvēla, the Deccan's rain nakṣatras) | — | `hc-calendars-indic` | Done — `nakshatra::solar_nakshatra_at` and its ingress and span functions: the Sun's entry into each of the twenty-seven arcs of 13°20′ under any ayanamsa. Against Drik Panchang's 2025 table every entry is eight to ten minutes early, the two Lahiri values being about 20″ apart. The periods' regional names and farming lore are not carried |
