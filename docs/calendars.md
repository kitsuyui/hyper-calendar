...
| Thai lunar (Chulasakarat) | `thai-lunar` | `hc-calendars-regional` | Planned — the *suriyayatra* rule for the extra month and the extra day, as J. C. Eade states it (*Journal of the Siam Society* 88, 2000), reproduces his year types for CS 1320–1340, but not the calendar the Makha, Visakha and Asalha Bucha dates of 1996–2031 imply: those differ from it in eight of the thirty-six years. The year types as Thailand publishes them are needed, as data, before the calendar can be carried |
