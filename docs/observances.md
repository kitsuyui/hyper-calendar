...
| Chinese folk | 除夕, 春節, 人日, 元宵, 上巳, 寒食, 清明, 端午, 七夕, 中元, 中秋, 重陽, 臘八, 冬至 | Done — 人日 1/7 and 上巳 3/3 (Wikipedia zh, "人日", "上巳節"); 寒食 the day before 清明, as kept after the 時憲曆 of 1645 (Wikipedia zh, "寒食节", `wikipedia-zh-hanshi`), the older 冬至 plus 105 days being `hc-seasons`' `ColdFoodConvention::SolsticePlus105`. 上巳's earlier "三月上旬的巳日" is not carried: it is not quite the first 巳 day, and it was kept before the Wei–Jin, centuries before `chinese` begins in 1645 |
| Little New Year, 小年 (`chinese-xiaonian-north`, `-south`, `-jiangnan`, `-nanjing`, `-southwest`) | One table per region: 12/23 in the north, 12/24 in the south, the eve of 除夕 in Jiangnan, the Wu area, most of Fujian and Taiwan, 1/15 around Nanjing, 除夕 in parts of the south-west | Done — Wikipedia zh, "小年" (`wikipedia-zh-xiaonian`); checked against Xinhua's 10 and 11 February 2026 for the north and south |
| Taoist days (`taoist`) | 上元 1/15, 中元 7/15 and 下元 10/15, the Three Officials' birthdays; Mazu's birthday on 3/23 and her ascension on 9/9, on `chinese` | Done — from secondary sources (Wikipedia zh, "下元節"; Wikipedia, "Mazu"), checked against TVBS's Mazu birthday of 20 April 2025. The other deities' days want a temple or almanac source |
...
| Vietnamese folk days (`vietnamese-folk`) | Tết Khai Hạ 1/7, Nguyên Tiêu 1/15, Hàn Thực 3/3, Đoan Ngọ 5/5, Trung Nguyên (Vu Lan) 7/15, Trung Thu 8/15, Trùng Cửu 9/9, Trùng Thập 10/10, Hạ Nguyên 10/15 and Ông Công Ông Táo 12/23 on `vietnamese` | Done — the Vietnam News Agency's list of the lunar tết (Vietnam+, 21 January 2012, `vnplus-tet-am-lich`), checked against Vietnam+'s Ông Táo of 22 January 2025 and VietNamNet's Trung Thu of 6 October 2025. Tết Thanh Minh, which the list puts "in the third month", is a solar term and not repeated. None is a day off |
...
| Plough Monday, Plough Sunday and Distaff Day (`plough-days`) | The first Monday after 6 January, the Sunday between 7 and 13 January, and 7 January | Done — Hone's "The first Monday after Twelfth-day" (*The Every-Day Book*, 1825, in transcription, `hone1825`), so 13 January when the 6th is a Monday, as in 2025; Plough Sunday on the date rule of Wikipedia, "Plough Sunday", which puts it after Plough Monday when 6 January is a Sunday. The regional first- or second-Monday variants would be their own tables |
