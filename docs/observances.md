...
| Tradition | Coverage | Status |
| --- | --- | --- |
| Lectionary year cycles — the Revised Common Lectionary's years A, B and C with the numbered Propers, and the Roman Lectionary's Sunday cycle A, B, C and weekday Years I and II | Which year of readings a date falls in, and which Proper a Sunday is | Planned — Year A "always begins on the First Sunday of Advent in years which can be evenly divided by three", with the Proper-by-date table, Proper 29 being the Sunday between 20 and 26 November (Consultation on Common Texts, *Revised Common Lectionary: Introduction*, §8); the Roman weekday cycle, Year I in odd years (Wikipedia, "Lectionary", "Ordo Lectionum Missae"; the *Ordo*'s praenotanda not read). Computus arithmetic and a rule, not the copyrighted readings, and so not the out-of-scope *ordo* of [calendars.md](calendars.md) |
| Ember and Rogation Days | The four Ember weeks and the Rogation Days, one table per church | Planned — `ember-bcp1662`: the Wednesday, Friday and Saturday after the first Sunday in Lent, after Pentecost, after 14 September and after 13 December, and Rogation the Monday to Wednesday before Ascension, with a vigil falling on a Sunday moved to the Saturday (Church of England, *Book of Common Prayer* 1662, "A Table of the Vigils, Fasts, and Days of Abstinence"). `ember-common-worship`: Common Worship keeps Ember Days "in the week before an ordination", which does not compute, and names the traditional weeks before the third Sunday of Advent and the second of Lent and before the Sundays nearest 29 June and 29 September (Church of England, *Common Worship*, "Rules to Order the Christian Year"). The Episcopal Church's September set and the Major Rogation of 25 April differ again (Wikipedia, "Ember days", "Rogation days") |
...
| Armenian Apostolic | Theophany on 6 January, the five Tabernacle feasts, Vardavar 98 days after Easter, the Assumption and the Exaltation on the Sundays nearest 15 August and 14 September, Great Lent from the seventh Monday before Easter, and saints' days only on Monday, Tuesday, Thursday and Saturday | Planned — two tables, since Etchmiadzin took the Gregorian calendar in 1923 and the Patriarchate of Jerusalem keeps the Julian (Armenian Apostolic Church of Sydney, "Liturgical Year of the Armenian Apostolic Church"; Wikipedia, "Vardavar"). The Armenian calendar itself is `armenian` |
| Astronomical Easter (WCC and MECC, Aleppo 1997) | The Sunday after the first astronomical full moon after the astronomical vernal equinox, on the meridian of Jerusalem | Planned — a proposal never adopted, as a `Computus` entry of its own, with the consultation's table of astronomical, Gregorian and Julian Easters for 2001–2025 to test against (World Council of Churches, "Towards a Common Date for Easter", `wcc-aleppo-1997`; `astronomical-easter` in `calendar-code2`). The consultation gives no rule for a full moon that falls on a Sunday; its table settles the cases it covers. `hc-holiday`'s computus module mentions it and no roadmap row did |
...
| Tradition | Coverage | Status |
| --- | --- | --- |
| Jewish, further days | Ta'anit Esther, and *Sh'ela*, the start of the prayer for rain outside the Land of Israel | Planned — Ta'anit Esther the day before Purim, or the Thursday before when Purim is on a Sunday (`ta-anit-esther` in `calendar-code2`); Sh'ela on Coptic 26 Hatur, sixty days after Samuel's autumn *tekufah* (`sh-ela`). Additions to the Jewish table |
| Yahrzeit and Hebrew birthday | The anniversary of a Hebrew date in a later year | Planned — the rules for a date on 30 Marheshvan, 30 Kislev, in Adar I or II or on 30 Adar I, where the later year may lack the month or the day (`yahrzeit` and `hebrew-birthday` in `calendar-code2`). A function on `hebrew` rather than a table |
...
| Samaritan festivals | Passover on 1/14, Unleavened Bread 1/15–21, 7/1, the Day of Atonement on 7/10, Tabernacles on 7/15 and 7/22 on `samaritan` | Planned — the festivals as the community's calendar gives them, with its autumn of 2026 as the check: 7/1 on 11 October, Atonement on 20 October, 7/22 on 1 November (the-samaritans.net, "Samaritan Calendar", `samaritans-net-calendar`). Shavuot is Researching, since the source gives no counting rule; [systems/samaritan.md](systems/samaritan.md) names the festivals as not carried |
| Mandaean feasts | Dehwa Hanina on 18 Taura, Ashuriyah on 1 Sartana, Dehwa Daimana on 1 Hatia and the *mbattal* days, beside Dehwa Rabba and the Parwanaia that `mandaean` carries | Planned — fixed days of `mandaean` (Drower, *The Mandaeans of Iraq and Iran*, pp. 86–92, `drower1937`), which [systems/mandaean.md](systems/mandaean.md) assigns to `hc-holiday` |
| Yazidi feasts | The Feast of the Assembly of 23–30 September, the *tiwafs* of Nisan, the fasts of December | Planned — on the Eastern (Julian) calendar beside `yazidi`, from the sources [systems/yazidi.md](systems/yazidi.md) already cites, Kreyenbroek for the Feast of the Assembly's dates (`kreyenbroek1995`); that document names them as not carried. The tiwafs and the fasts want a source that dates them |
...
| Recurring events with a defining authority — the modern Olympiads ([policy.md](policy.md) §10) | Planned — the number of the Olympiad a year belongs to, counted from 1896, with the Games that were not held keeping their numbers, VI in 1916, XII in 1940, XIII in 1944 (Olympedia, "Olympiad", on the Olympic Charter as revised on 1 September 2004; Wikipedia, "Olympiad"). The Charter itself was not read; the ancient Olympiads are a year count in [calendars.md](calendars.md) stage 4 |
