...
| --- | --- | --- |
| Christian, Gregorian computus (`christian-western`) | Easter and thirteen feasts keyed to it, from Ash Wednesday to the Sacred Heart, plus Advent, Christmas, Epiphany, Candlemas, All Saints and the other fixed feasts | Done — `computus::offsets` names 22 offsets, from Septuagesima, for the country tables to choose from; this table dates the fourteen days from Ash Wednesday to the Sacred Heart, Easter Sunday among them |
| Christian, Julian computus (Orthodox) (`christian-orthodox`) | Orthodox Pascha and its cycle, Julian-dated fixed feasts; the Julian date and the civil date are both available | Done |
...
| Astronomical Easter (`astronomical-jerusalem`) | The Sunday after the first full moon after the March equinox, both at the meridian of Jerusalem, as the World Council of Churches and the Middle East Council of Churches proposed at Aleppo in 1997 | Done — a `Computus` entry beside `gregorian` and `julian`, which no church keeps; reproduces the consultation's 25 Easters and vernal full moons of 2001–2025, whose 2001, 2021 and 2025 settle a full moon on a Sunday as the Sunday after (`wcc-aleppo-1997`), dated in apparent time at Jerusalem as Reingold and Dershowitz's `astronomical-easter` dates it; 1583–2150, see [systems/astronomical-easter.md](systems/astronomical-easter.md) |
...
| Chaharshanbe Suri (`chaharshanbe-suri`) | The Tuesday evening before the last Wednesday of the Solar Hijri year, on `persian` | Done — "شبِ آخرین چهارشنبهٔ سال (از غروب سه‌شنبه)" (Wikipedia fa, "چهارشنبه‌سوری"), so when Nowruz is a Wednesday the festival is a week before the year's last day, as on 12 March 2024; checked against Wikipedia's 2025–2027 dates |
...
| Chinese folk (`chinese-folk`) | 除夕, 春節, 人日, 元宵, 上巳, 寒食, 清明, 端午, 七夕, 中元, 中秋, 重陽, 臘八, 冬至 | Done — 人日 1/7 and 上巳 3/3 (Wikipedia zh, "人日", "上巳節"); 寒食 the day before 清明 from 1645, when the 時憲曆 shortened the interval from the solstice, and 105 days after 冬至 before it (Wikipedia zh, "寒食节", `wikipedia-zh-hanshi`), the two being `hc-seasons`' `ColdFoodConvention::EveOfQingming` and `SolsticePlus105`; the older entry is approximate, its solstice being today's astronomy rather than the older calendars' own. 上巳's earlier "三月上旬的巳日" is not carried: it is not quite the first 巳 day, and it was kept before the Wei–Jin, centuries before `chinese` begins in 1645 |
| Little New Year, 小年 (`chinese-xiaonian-north`, `-south`, `-jiangnan`, `-nanjing`, `-southwest`) | One table per region: 12/23 in the north, 12/24 in the south, the eve of 除夕 in Jiangnan, the Wu area, most of Fujian and Taiwan, 1/15 around Nanjing, 除夕 in parts of the south-west | Done — Wikipedia zh, "小年" (`wikipedia-zh-xiaonian`); checked against Xinhua's 10 and 11 February 2026 for the north and south (`xinhua-xiaonian-2026`) |
| Taoist days (`taoist`) | 上元 1/15, 中元 7/15 and 下元 10/15, the Three Officials' birthdays; Mazu's birthday on 3/23 and her ascension on 9/9, on `chinese` | Done — from secondary sources (Wikipedia zh, "下元節"; Wikipedia, "Mazu"), checked against TVBS's Mazu birthday of 20 April 2025 (`tvbs-mazu-2025`). The other deities' days want a temple or almanac source |
| Korean folk days (`korean-folk`) | 정월대보름 1/15, 영등날 2/1, 삼짇날 3/3, 단오 5/5, 유두 6/15, 칠석 7/7, 백중 7/15, 중양절 9/9, 시월보름 10/15 and 섣달그믐 on `dangi`, and 한식 105 days after 동지 | Done — the lunar days from Wikipedia ko, "한국의 명절", and the *Encyclopedia of Korean Culture*'s "명절" and "세시풍속"; 한식 from its "한식" (`aks-hansik`), the 105 days counted after the solstice's day as KASI's 한식 of 2024–2026 require (`kasi-wollyeok`; [systems/solar-term-counts.md](systems/solar-term-counts.md)), with KASI's 단오 and 칠석 of the same years as checks. None is a day off |
| Vietnamese folk days (`vietnamese-folk`) | Tết Khai Hạ 1/7, Nguyên Tiêu 1/15, Hàn Thực 3/3, Đoan Ngọ 5/5, Trung Nguyên (Vu Lan) 7/15, Trung Thu 8/15, Trùng Cửu 9/9, Trùng Thập 10/10, Hạ Nguyên 10/15 and Ông Công Ông Táo 12/23 on `vietnamese` | Done — the Vietnam News Agency's list of the lunar tết (Vietnam+, 21 January 2012, `vnplus-tet-am-lich`), checked against Vietnam+'s Ông Táo of 22 January 2025 (`vnplus-ong-tao-2025`) and VietNamNet's Trung Thu of 6 October 2025 (`vietnamnet-trung-thu-2025`). Tết Thanh Minh, which the list puts "in the third month", is a solar term and not repeated. None is a day off |
| Japanese 五節句 (`gosekku`) | 人日 1/7, 上巳 3/3, 端午 5/5, 七夕 7/7, 重陽 9/9 on the Gregorian calendar, from 1873 | Done — Wikipedia ja, "節句", with their abolition as official festivals by the Council of State's notice No. 1 of 1873 (not read). The National Astronomical Observatory's 伝統的七夕 is `hc-seasons`' `moon_calendar::traditional_tanabata`, reproducing the Observatory's forty dates of 2011–2050 (`nao-faq-tanabata`). The 月遅れ reckoning is in no source read |
| Tibetan Buddhist *düchen* (`buddhist-tibetan`) | Losar 1/1, Saga Dawa 4/15, the Universal Prayer Day 5/15, Chökhor Düchen 6/4 and Lhabab 9/22 on `tibetan` | Done — the Tibetan Nuns Project's 2024 list (`tnp-losar`), whose Chökhor Düchen of 9 July is in the Phugpa leap month 6 and on the first of two fourth days; a skipped or repeated day, and a repeated month, is a reported gap (`TibetanMonth::Unrepeated`, [systems/tibetan-calendar-holidays.md](systems/tibetan-calendar-holidays.md)) |
| Theravada *uposatha* days, Thai (`buddhist-uposatha-thai`) | ขึ้น 8 ค่ำ, ขึ้น 15 ค่ำ, แรม 8 ค่ำ, and แรม 15 ค่ำ, or แรม 14 ค่ำ in a month of 29 days, on `thai-lunar` | Done for 1992–2027, the years `thai-lunar` publishes, and gaps outside — the rule of Wikipedia th, "วันพระ", the month lengths of the calendar's year types, checked against Thai PBS's วันพระ of 2025 (`thaipbs-wanphra-2568`) |
| Hindu (`hindu`) | Makar Sankranti, Maha Shivaratri, Holika Dahan and Holi, Ugadi, Rama Navami, Mahavir Jayanti, Mesha Sankranti, Akshaya Tritiya, Buddha Purnima, Guru Purnima, Raksha Bandhan, Krishna Janmashtami, Ganesh Chaturthi, Navaratri, Durga Ashtami, Vijaya Dashami, Diwali, Guru Nanak Jayanti, Thaipusam | Done — each on the part of the day its tithi must hold, at the national almanac's sunrise; reproduces the Rashtriya Panchang's festival lists for 2023–2025. Thaipusam is a nakṣatra rule, Puṣya in Thai, fitted to the days Malaysia and Mauritius gazetted for 2020–2026 |
...
| Shinto (`shinto`, `kyuchu-saishi`) | 初詣, 節分, 大祓, 七五三; the imperial court rites 宮中祭祀 as a second table | Done — `shinto` for the year as kept at a shrine and at home, 節分 as the eve of 立春 at the Japanese meridian; `kyuchu-saishi` for the Reiwa-era schedule of the 大祭, 小祭 and 旬祭, the equinox rites on 春分の日 and 秋分の日, 天長祭 bounded to its 2020 start. A shrine's own festival days are not carried |
| Pagan / Wheel of the Year (`wheel-of-the-year`, `wheel-of-the-year-south`) | Samhain, Yule, Imbolc, Ostara, Beltane, Litha, Lughnasadh, Mabon | Done — two tables, northern and southern hemisphere; the quarter days on their Universal Time day, the cross-quarter days on their fixed dates; eve and nearest-weekend conventions not modelled |
| Plough Monday, Plough Sunday and Distaff Day (`plough-days`) | The first Monday after 6 January, the Sunday between 7 and 13 January, and 7 January | Done — Hone's "The first Monday after Twelfth-day" and "St. Distaff's day, or the morrow after Twelfth-day" (*The Every-Day Book*, vol. 1, 1826, read in Tegg's reissue and a transcription, `hone1826`), so 13 January when the 6th is a Monday, as in 2025; Plough Sunday on the date rule of Wikipedia, "Plough Sunday" (`wikipedia-plough-sunday`), which puts it after Plough Monday when 6 January is a Sunday. The regional first- or second-Monday variants would be their own tables |
...
| Secular international (`un-days`) | The United Nations' international days — those of the General Assembly and of UNESCO, WHO, FAO and the other agencies on its list | Done — `international::UNITED_NATIONS`, every entry citing its resolution or designating body in `HolidayRule::source`; the seven rule-based days carry their rules; the weeks are not carried |
...
| Theravada *uposatha* days, other reckonings | The new moon, the full moon and the two quarter days on `burmese`, and the Mahayana sets of ten and six days a month on `chinese` | Planned (Wikipedia, "Uposatha"). The Thai reckoning is `buddhist-uposatha-thai`, above; the Dhammayuttika Nikāya's own days, which the article says may differ slightly, want a source that states them |
