...
| Mongolia 🇲🇳 | The Law on Public Holidays and Days of Observance, art. 4.1, and the Labour Law, art. 97.1: New Year, Women's Day, Children's Day, Naadam's six days, Republic Day from 2016 and 29 December from 2011; Tsagaan Sar, Buddha's Birthday and Chinggis Khaan Day are on the Mongolian lunar calendar and are reported as gaps in every year; nothing moves off the Saturday–Sunday weekend. The lunar calendar is now `hc-calendars-lunar`'s `mongolian`, checked against the Government's Tsagaan Sar of 2025, so the table can date those days from it — Tsagaan Sar the first three days of the first spring month, month 1; Buddha's Birthday the fifteenth of the first summer month, month 4; Chinggis Khaan Day the first of the first winter month, month 10 (Janson, Appendix A.3). It will need a rule for a lunar date the calendar omits: in 2025 the first day of the first spring month was omitted, and, the second and third falling on a weekend, resolution 109 gave the rest days on Monday to Wednesday, 3–5 March. That change to `hc-holiday` is not made here |
