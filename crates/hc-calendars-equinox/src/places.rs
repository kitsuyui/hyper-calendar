...
/// Dershowitz use for the astronomical Badíʿ calendar (`reingold2018code`,
/// `bahai-location`, elevation 0 m).
///
...
/// Tehran as Reingold and Dershowitz place it for the Solar Hijri
/// calendar: 35.68° N, 51.42° E, 1 100 m (`reingold2018code`, `tehran`).
/// Only the longitude matters to the calendar that uses it,
/// [`crate::persian_apparent_noon`], whose rule is the Sun's transit here;
