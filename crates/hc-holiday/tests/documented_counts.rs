...
fn hijri_dates_appear_in_the_number_of_countries_the_readme_states() {
    ...
    for expected in [
        "AE", "AL", "AR", "AZ", "BA", "BD", "BF", "BH", "BJ", "BN", "CI", "CM", "DZ", "EG", "ET",
        "GH", "GN", "GY", "ID", "IN", "IQ", "IR", "JO", "KE", "KG", "KW", "KZ", "LB", "LY", "MA",
        "ME", "MK", "ML", "MM", "MU", "MW", "MY", "NG", "NP", "OM", "PH", "PK", "PS", "QA", "RS",
        "SA", "SG", "SR", "SY", "TL", "TR", "TT", "TZ", "UG", "YE",
    ] {
        assert!(
