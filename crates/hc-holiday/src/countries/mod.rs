...
pub use africa_middle_east::{
    ...
    COMOROS, CONGO, COTE_D_IVOIRE, DJIBOUTI, DR_CONGO, EGYPT, EQUATORIAL_GUINEA, ETHIOPIA, GHANA,
    GUINEA, IRAN, IRAQ, ISRAEL, JORDAN, KENYA, KUWAIT, LEBANON, LESOTHO, LIBYA, MADAGASCAR, MALAWI,
    MALI, MAURITANIA, MAURITIUS, MOROCCO, MOZAMBIQUE, NAMIBIA, NIGERIA, OMAN, PALESTINE, QATAR,
    RWANDA, SAUDI_ARABIA, SENEGAL, SEYCHELLES, SOUTH_AFRICA, SYRIA, TANZANIA, TUNISIA, TURKEY,
    UGANDA, UNITED_ARAB_EMIRATES, YEMEN, ZAMBIA, ZIMBABWE,
};
pub use americas::{
...
pub use asia::{
    ARMENIA, AZERBAIJAN, BANGLADESH, BHUTAN, BRUNEI, CAMBODIA, CHINA, GEORGIA, HONG_KONG, INDIA,
    INDONESIA, KAZAKHSTAN, KYRGYZSTAN, LAOS, MACAU, MALAYSIA, MALDIVES, MONGOLIA, MYANMAR, NEPAL,
    PAKISTAN, PHILIPPINES, SINGAPORE, SOUTH_KOREA, SRI_LANKA, TAIWAN, TAJIKISTAN, THAILAND,
    TIMOR_LESTE, TURKMENISTAN, UZBEKISTAN, VIETNAM,
};
pub use europe::{
