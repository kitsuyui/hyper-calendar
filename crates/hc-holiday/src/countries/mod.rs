...
pub use africa_middle_east::{
    ALGERIA, ANGOLA, BAHRAIN, BOTSWANA, CAMEROON, CONGO, COTE_D_IVOIRE, DR_CONGO, EGYPT, ETHIOPIA,
    GHANA, IRAN, IRAQ, ISRAEL, JORDAN, KENYA, KUWAIT, LEBANON, LIBYA, MALAWI, MAURITIUS, MOROCCO,
    NAMIBIA, NIGERIA, OMAN, PALESTINE, QATAR, SAUDI_ARABIA, SENEGAL, SOUTH_AFRICA, SYRIA, TANZANIA,
    TUNISIA, TURKEY, UGANDA, UNITED_ARAB_EMIRATES, YEMEN, ZAMBIA, ZIMBABWE,
    ALGERIA, BAHRAIN, BENIN, BOTSWANA, BURKINA_FASO, CABO_VERDE, COTE_D_IVOIRE, EGYPT, ETHIOPIA,
    GHANA, GUINEA, IRAN, IRAQ, ISRAEL, JORDAN, KENYA, KUWAIT, LEBANON, LIBYA, MALAWI, MALI,
    MAURITIUS, MOROCCO, NAMIBIA, NIGERIA, OMAN, PALESTINE, QATAR, SAUDI_ARABIA, SENEGAL,
    SOUTH_AFRICA, SYRIA, TANZANIA, TUNISIA, TURKEY, UGANDA, UNITED_ARAB_EMIRATES, YEMEN, ZAMBIA,
    ZIMBABWE,
    ALGERIA, BAHRAIN, BOTSWANA, BURUNDI, COTE_D_IVOIRE, EGYPT, ETHIOPIA, GHANA, IRAN, IRAQ, ISRAEL,
    JORDAN, KENYA, KUWAIT, LEBANON, LESOTHO, LIBYA, MADAGASCAR, MALAWI, MAURITIUS, MOROCCO,
    MOZAMBIQUE, NAMIBIA, NIGERIA, OMAN, PALESTINE, QATAR, RWANDA, SAUDI_ARABIA, SENEGAL,
    SEYCHELLES, SOUTH_AFRICA, SYRIA, TANZANIA, TUNISIA, TURKEY, UGANDA, UNITED_ARAB_EMIRATES,
