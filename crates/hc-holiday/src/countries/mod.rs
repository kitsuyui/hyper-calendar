...
pub use africa_middle_east::{
    ...
    GUINEA, IRAN, IRAQ, ISRAEL, JORDAN, KENYA, KUWAIT, LEBANON, LESOTHO, LIBERIA, LIBYA,
    MADAGASCAR, MALAWI, MALI, MAURITANIA, MAURITIUS, MOROCCO, MOZAMBIQUE, NAMIBIA, NIGERIA, OMAN,
    PALESTINE, QATAR, RWANDA, SAUDI_ARABIA, SENEGAL, SEYCHELLES, SOUTH_AFRICA, SYRIA, TANZANIA,
...
pub use asia::{
    ...
    MYANMAR, NEPAL, PAKISTAN, PHILIPPINES, SINGAPORE, SOUTH_KOREA, SRI_LANKA, TAIWAN, TAJIKISTAN,
    THAILAND, TIMOR_LESTE, TURKMENISTAN, UZBEKISTAN, VIETNAM,
};
pub use europe::{
