...
| `day_counts` | Lilian, ANSI, Dublin, Reduced, Truncated, CNES, CCSDS, Chronological Julian and MJD2000 day counts; the Excel 1904 serial and the OLE Automation day; SAS dates, Stata's `%td` and its 52-week year, and MATLAB's `datenum` | `lilian`, `ansi-date`, `dublin-julian-day`, `reduced-julian-day`, `truncated-julian-day`, `cnes-julian-day`, `ccsds-day`, `chronological-julian-day`, `modified-julian-day-2000`, `excel-1904`, `ole-automation-date`, `sas-date`, `stata-date`, `stata-week`, `matlab-datenum` |
| `spreadsheet` | The Excel 1900 serial, refusing the phantom 29 February 1900, and the fractional time of the OLE Automation date and of MATLAB's `datenum` | `excel-1900` |
